...
export default function Product() {
  ...
  const solidStar = product && product.totalrating ? product.totalrating : 0;
  ...
  const isProductInWishlist =
    (product && currentUser?.wishlist?.includes(product._id)) || false;
    ...
    <>
      {product ? (
        <>
          ...
          {product && <ReviewRating product={product} />}
        ...
        <div className="flex gap-3 justify-center items-center text-3xl my-10">
          <HiExclamation size={32} />
          <p>Product is not avaiable!</p>
        </div>
      )}
    </>
  );
